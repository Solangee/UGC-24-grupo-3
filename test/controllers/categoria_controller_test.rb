...
class CategoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorium" do
    assert_difference('Categorium.count') do
      post categoria_url, params: { categorium: { nombre: @categorium.nombre, padre_id: @categorium.padre_id } }
    end
  ...
  test "should update categorium" do
    patch categorium_url(@categorium), params: { categorium: { nombre: @categorium.nombre, padre_id: @categorium.padre_id } }
